...
public class ControllerToView {
	...
	public ModelAndView list2() {	//return 타입은 String이 아닌 ModelAndView 클래스
		...
		mv.setViewName("member/memberList");	//포워딩할 jsp 파일명
		
		//setViewName 메소드 대신 생성자의 인수로 jsp 페이지명 지정
		//ModelAndView mv2 = new ModelAndView("member/memberList");
		
		mv.addObject("from", "list2");			//addObject 메소드를 이용하여 데이터 전송
	...
	// 예시 3) httpServeletRequest 인터페이스 이용(사용빈도 적음)
